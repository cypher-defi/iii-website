      ...
      .map(
        (e, i) =>
          `<tr style="background:${i % 2 === 0 ? '#f9f9f9' : '#ffffff'}">
            <td style="padding:10px 14px;font-size:14px;color:#0E0E0E;">${e.name}</td>
...
<body style="margin:0;padding:20px;background:#f4f4f4;font-family:Arial,sans-serif;">
  <div style="max-width:580px;margin:0 auto;background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
    ...
    <div style="background:#0E0E0E;padding:28px 32px;text-align:center;">
      <div style="font-size:30px;font-weight:800;color:#ffffff;letter-spacing:6px;">III</div>
      <div style="color:#6b6b6b;font-size:10px;letter-spacing:3px;margin-top:6px;text-transform:uppercase;">Inversiones Industriales Ibarra</div>
    </div>
    ...
    <div style="padding:32px;">
      <div style="background:${statusColor}10;border-left:4px solid ${statusColor};padding:18px 20px;border-radius:6px;margin-bottom:28px;">
        ...
        <div style="font-size:20px;font-weight:700;color:#0E0E0E;">${newEntry.name}</div>
      ...
      ${
        confirmed.length > 0
          ? `<div style="margin-bottom:24px;">
              <div style="font-size:11px;font-weight:700;color:#0E0E0E;text-transform:uppercase;letter-spacing:2px;margin-bottom:10px;">
